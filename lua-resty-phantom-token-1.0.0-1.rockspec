...
description = {
  ...
  detailed = [[
        ...
        The Identity Server stores JWT access tokens issued and returns opaque tokens to internet clients.
        This ensures that no sensitive token related data can be revealed.
